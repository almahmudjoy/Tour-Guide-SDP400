    ...
    >
      ...
      <View className="flex items-center mt-10">
        <View className="w-2/3">
          ...
          <Text
            className={`text-3xl font-bold mb-4 text-center text-green-400`}
          >
            Village Tour BD
          </Text>

          <Text className={`text-gray-400 mb-2 text-center`}>
            Explore exciting locations around the Bangladesh village
          </Text>
        </View>
      </View>
      ...
      <View className="flex items-center">
        <TouchableOpacity
          onPress={allClearFilter}
          className={`flex-row items-center mb-4 bg-green-500 p-2 px-5 rounded-3xl`}
        >
      ...
      <View className={`px-4 rounded-md bg-[#000000bd] py-4 m-2`}>
        <Picker
          ...
          style={{
            ...
            color: selectedDistrict ? "#fff" : "gray",
            borderRadius: 10,
          }}
        ...
        >
          ...
          {fetchingDistrict && (
            <Picker.Item label="Loading..." value="No Value" />
          )}
        ...
        >
          ...
          {!isFetcingType &&
            placetypesare?.length > 0 &&
            placetypesare?.map((item, index) => {
              return (
                <Picker.Item
                  key={index}
                  label={item?.name}
